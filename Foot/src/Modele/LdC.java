...
//          
//      }
    public void simulation_LdC() throws SQLException {
        this.melange_array(this.liste_LDC);
        this.faire_8_groupes_de_4();
        this.affrontements_des_8_groupes();
        this.premiere_phase();
        this.r.classer_array_LDC(winner);
        this.affrontements();
        this.get_gagnant();
...
public Equipe get_gagnant () throws SQLException //à utiliser 
  {
    finale.clear();
    finale=r.getEquipeByChampionnat("champions league");
  JOptionPane.showMessageDialog(null,"Le gagnant de la league des champions est: "+this.finale.get(0).getNom()+"!","message",JOptionPane.INFORMATION_MESSAGE);
  return this.finale.get(0);
   
  }

    public void fight_ldc(ArrayList<Equipe> a) throws SQLException // toutes les equipes s'affrontent entre elles
    {
